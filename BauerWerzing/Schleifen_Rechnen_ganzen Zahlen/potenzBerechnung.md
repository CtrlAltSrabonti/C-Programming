...
<img width="643" height="203" alt="image" src="https://github.com/user-attachments/assets/33e43828-7cfc-43b0-9331-0e72d1a09969" />
...
int main(void)
{
    ...
    while (exp < 0)
    { /*Vorteil while schleife: Die bedingung wird vor jedem Durchlauf geprüft*/
    ...
    /*Ablauf der Berechnung*/
    /*For while loop, there is no EXTRA if condition check is necessary */

    /*Initialisation*/
    ergebnis = 1; /*mathematisch b°0 = 1*/
    i = 0;
    
    /*Advantage of while loop: condition is checked first before iteration */
